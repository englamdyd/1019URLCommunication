...
public class ImageDownload extends AppCompatActivity {
            ...
            if(message.obj != null){
                ...
                String path =
                        Environment.getDataDirectory()
                                .getAbsolutePath();
                //현재 앱 내의 파일 경로 만들기
                path = path + "/data/com.example.a503_16." + "a1019urlcommunication/files/" + (String)message.obj;
    ...
    class DisplayThread extends Thread{
        ...
        public void run(){
            try{
                String addr = "http://kr.people.com.cn/NMediaFile/2018/1019/FOREIGN201810190948000135524627587.jpg";                URL url = new URL(addr);
                //url에 연결해서 비트맵 만들기
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //이미지를 다운로드 받을 주소
                String imageUrl =
                        "http://file2.instiz.net/data/file2/2016/07/14/f/f/7/ff7e0e563c2257978c06e1ca48be37cf.jpg";
                //파일명 만들기
                ...
                String path = data +
                        "/data/com.example.a503_16." + "a1019urlcommunication/files/" + filename;
                //Log.e("파일경로", path);
                //파일 존재 여부를 확인
